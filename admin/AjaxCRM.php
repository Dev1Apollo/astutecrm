...
//    else {
//        $where.=" and STR_TO_DATE(strEntryDate,'%d-%m-%Y')>= STR_TO_DATE('" . $date . "','%d-%m-%Y')";
//    }
    ...
    if (isset($_REQUEST['applicatipnNo']) && $_REQUEST['applicatipnNo'] != '') {
        $where.=" and applicatipnNo  like '" . trim($_REQUEST['applicatipnNo']) . "' ";
    } 
//    else {
//        $where.=" and STR_TO_DATE(strEntryDate,'%d-%m-%Y')<=STR_TO_DATE('" . $date . "','%d-%m-%Y')";
//    }

    $filterstr = "SELECT * FROM `application`  " . $where . " and isDelete='0'  and  iStatus='1' order by iAppId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `application`  " . $where . " and isDelete='0' and  istatus='1' ";
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop">Loan Application No</th>
                    <th class="desktop">Customer Name</th>
                    <th class="desktop">Customer City</th>
                    <th class="desktop">Loan Amount</th>
                    <th class="desktop">EMI Amount</th>
                    <th class="desktop">Agency Name</th>
                    <th class="desktop">FOS Name</th>
                    <th class="desktop">FOS Contact</th>
                </tr>
            </thead>
            <tbody>
                <?php
