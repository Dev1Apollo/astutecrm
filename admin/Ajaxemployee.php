        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop">Manager T&Q</th> 
                    <th class="desktop">Manager Ops</th> 
                    <th class="desktop">Manager HR</th> 
                    <th class="desktop">Manager IT</th> 
                    <th class="desktop">Manager WFM/MIS</th> 
