...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `incentivemaster`  " . $where . " and isDelete='0'  and  istatus='1' order by incentiveId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `incentivemaster`  " . $where . " and isDelete='0' and  istatus='1' ";
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop">Incentive Scheme</th>
                    <th class="desktop">Incentive Earned</th>
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['incentiveScheme']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['incentiveEarned']; ?>                           
                            </div>
                        </td>
                        <td>
