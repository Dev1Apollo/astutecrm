...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `dispositionmaster`  " . $where . " and masterDispoId=0 order by  iDispoId desc";
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                   ...
                   <th class="none">Mian Disposition</th>
                    <th class="desktop">Disposition Code</th>
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        <td>
                            <div class="form-group form-md-line-input "><?php  if($rowfilter['dispoType'] == 1)
                                {echo 'Connect';}else{echo 'Not Connect';} ?> 
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php  echo $rowfilter['dispoCode']; ?> 
                            </div>
                        </td>
