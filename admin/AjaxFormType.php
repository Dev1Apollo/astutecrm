...
//        if ($_POST['Search_Txt'] != '') {
//
//            $where.=" and  formName like '%$_POST[Search_Txt]%'";
//        }
//    }
//    $filterstr = "SELECT * FROM `formtype`  " . $where . " and isDelete='0'  and  istatus='1' order by formId desc";
//    $countstr = "SELECT count(*) as TotalRow FROM `formtype` " . $where . " and isDelete='0' and  istatus='1' order by formId desc";
