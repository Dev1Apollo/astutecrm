...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Add  Employee Quality </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo $web_url; ?>admin/dailyupdate.php">List Of  Employee Quality</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>Add Employee Quality</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase"> Add  Employee Quality</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddEmployeeQualityData" name="action" id="action">
                                                <div class="form-body"> 
        ...
        <script type="text/javascript">
            function checkclose() {
                window.location.href = '<?php echo $web_url; ?>admin/Quality.php';
            }
            ...
            $('#frmparameter').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>admin/querydataEmployee.php',
...
//                        window.location.href = '<?php echo $web_url; ?>admin/Incentive.php';
