                            ...
                            <div class="col-md-12">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        ...
                                        <a href="<?php echo $web_url; ?>admin/AddTLDashboard.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD TL Dashboard"> <i class="fa fa-upload"></i></a>
                                    </div>
        ...
        <script type="text/javascript">
                                                        ...
                                                        function deletedata(task, id)
                                                        {
                                                            ...
                                                            if (confirm(errMsg)) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "<?php echo $web_url; ?>admin/AjaxTLDashboardData.php",
