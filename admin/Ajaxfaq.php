...
if ($_POST['action'] == 'ListUser') {
    ...
    if (isset($_REQUEST['Search_Txt'])) {
        if ($_POST['Search_Txt'] != '') {
            $where.=" and  strfaq like '%".trim($_POST[Search_Txt])."%'";
        }
    }
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $strLanguage = mysqli_fetch_array(mysqli_query($dbconn,"Select * from language where languageid='".$rowfilter['language']."' "));
                            echo $strLanguage['language']; ?> 
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "> 
                                <a class="btn blue" onClick="javascript: return setEditdata('<?php echo $rowfilter['faqid']; ?>');"  title="Edit"><i class="fa fa-edit iconshowFirst"></i></a> 
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php echo $rowfilter['faqid']; ?>');"   title="Delete"><i class="fa fa-trash-o iconshowFirst"></i></a>
                            </div>
                        </td>
                        <?php
                    }
