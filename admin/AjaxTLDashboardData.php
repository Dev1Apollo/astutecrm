...
if ($_POST['action'] == 'ListUser') {
    ...
    if (isset($_REQUEST['formDate']) && $_REQUEST['formDate'] != '') {
        $where.=" and STR_TO_DATE(date,'%d-%M-%Y')>= STR_TO_DATE('" . $_REQUEST['formDate'] . "','%d-%M-%Y')";
    } else {
        $where.=" and STR_TO_DATE(date,'%d-%M-%Y')>= STR_TO_DATE('" . $date . "','%d-%M-%Y')";
    }
    ...
    $filterstr = "SELECT * FROM `tldeshboardmaster`  " . $where . " and isDelete='0'  and  istatus='1' order by tlDeshboardId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `tldeshboardmaster`  " . $where . " and isDelete='0' and  istatus='1' ";
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop"> Total Agents </th>
                    <th class="desktop">Attendance</th>
                    <th class="desktop"> Login Hours Target </th>
                    <th class="desktop"> Login Hours Delivered </th>
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['totalAgent']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['attendance']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['loginHoursTarget']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['loginHoursDelivered']; ?>                           
                            </div>
                        </td>
                        <td>
