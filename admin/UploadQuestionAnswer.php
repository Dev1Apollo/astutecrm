...
<html lang="en">
   <head>
      ...
      <link href="<?php echo $web_url; ?>admin/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css" rel="stylesheet" type="text/css" />
      <link href="<?php echo $web_url; ?>admin/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
   </head>
                ...
                <div class="page-content">
                    <div class="container">
                      <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo $web_url;?>admin/Exam.php">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase" id="FAQ">Upload Question Answer</span>
                                        </div>
                                    </div>
