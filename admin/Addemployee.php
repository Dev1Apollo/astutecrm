...
<body class="page-container-bg-solid page-boxed">
                                    ...
                                    <div class="portlet-body form">
                                        <form role="form" method="POST" action="" name="frmparameter" id="frmparameter" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <!--<div id="DivFieldCo">
                                                    <div class="form-group col-md-4">
                                                        <label for="form_control_1">Field Coordinator</label>
                                                        <select class="form-control" name="fieldCoid" id="fieldCoid" required="required">
    ...
    <script type="text/javascript">
        ...
        function getManagerOps(){
            var id = $("#centralmanager").val();
            $.ajax({
                type: 'POST',
                url: '<?php echo $web_url; ?>admin/querydata.php',
                data: {
                    action: "getManagerOps",
                    ID: id
                },
                success: function(response) {
                    console.log(response);
        ...
        function getManagerMIS(){
            var id = $("#centralmanager").val();
            $.ajax({
                type: 'POST',
                url: '<?php echo $web_url; ?>admin/querydata.php',
                data: {
                    action: "getManagerMIS",
                    ID: id
                },
                success: function(response) {
                    console.log(response);
