...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Feedback </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase" id="Feedback">Add Feedback</span>
                                            </div>
                                        </div>
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="strFeedback" id="strFeedback"  class="form-control" placeholder="Enter Feedback Name" required="" type="text">
        ...
        <script type="text/javascript">
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url;?>admin/querydata.php',
                    data: {action: "GetAdminFeedback", ID: id},
                    success: function (response) {
                        document.getElementById("Feedback").innerHTML = "EDIT Feedback";
                        $('#loading').css("display", "none");
                        var json = JSON.parse(response);
                        $('#strFeedback').val(json.strfeedbackName);
                        $('#action').val('EditFeedback');
                        $('<input>').attr('type', 'hidden').attr('name', 'iFeedbackId').attr('value', json.iFeedbackId).attr('id', 'iFeedbackId').appendTo('#frmparameter');
                    }
                });
            }
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>admin/AjaxFeedback.php",
