...
if ($_POST['action'] == 'ListUser') {
    ...
    if (isset($_REQUEST['Search_Txt'])) {
        if ($_POST['Search_Txt'] != '') {
            ...
            $where.=" and  processname like '%".trim($_POST[Search_Txt])."%'";
        }
    }

    $filterstr = "SELECT * FROM `processmaster`  " . $where . " and isDelete='0'  and  istatus='1' order by  processmasterid desc";
    $countstr = "SELECT count(*) as TotalRow FROM `processmaster` " . $where . " and isDelete='0' and  istatus='1' ";
...
<!--                    <th class="none">Upload date & time</th>-->
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['processname']; ?> 
                            </div>
                        </td>
...
if ($_REQUEST['action'] == 'Delete') {
    ...
    $where = ' where processmasterid=' . $_REQUEST['ID'];
