...
//    }
    if ($_POST['Address'] != '') {
        $where.=" and  address like '%". trim($_POST[Address]). "%'";
    }
...
<!--                    <th class="desktop">Zone</th>-->
                    ...
                    <th class="desktop">Merchant Name/Store Name/Dealer Name</th>
<!--                    <th class="desktop">SO Name</th>
                    <th class="desktop">ASM</th>-->
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['partner']; ?> 
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['city']; ?> 
                            </div>
                        </td>
<!--                        <td>
                            <div class="form-group form-md-line-input "><?php // echo $rowfilter['zone']; ?> 
                            </div>
                        </td> -->
                        <td>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['storeName']; ?> 
                            </div>
                        </td> 
<!--                        <td>
                            <div class="form-group form-md-line-input "><?php // echo $rowfilter['SOname']; ?> 
                            </div>
                        </td> 
                        <td>
                            <div class="form-group form-md-line-input "><?php // echo $rowfilter['ASM']; ?> 
                            </div>
                        </td>-->
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['zone']; ?> 
                        ...
                        <td style="width: 20%">
                            <div class="form-group form-md-line-input">
                                <a  class="btn blue" href="<?php echo $web_url; ?>admin/EditStoreLocator.php?token=<?php echo $rowfilter['storeListId']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php echo $rowfilter['storeListId']; ?>');"   title="Delete"><i class="fa fa-trash-o iconshowFirst"></i></a>
                            </div>
                        </td>
