        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="all">Agecny Name</th>
                    <th class="none">From Email</th>
                    <th class="desktop">To Email</th>
                    <th class="desktop">cc Email</th>
                </tr>
            </thead>
            <tbody>
                <?php
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['frommail']; ?> 
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['emailto']; ?> 
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['cc']; ?> 
                            </div>
                        </td>
