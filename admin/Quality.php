...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Employee Quality </title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Employee Quality </span>
                                        </div>
                                        <a href="<?php echo $web_url; ?>admin/AddEmployeeQuality.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Employee Quality"><i class="fa fa-upload"></i> </a>
                                    </div>
        ...
        <script type="text/javascript">
                                                        ...
                                                        function deletedata(task, id)
                                                        {
                                                            ...
                                                            if (confirm(errMsg)) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "<?php echo $web_url; ?>admin/AjaxQualityData.php",
