        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            ...
            <thead class="tbg">
                ...
                <tr>
                    ...
                    <th class="all">Exam Title</th>
                    <th class="all">Exam Total Question</th>
                    <th class="all">Exam Total Marks</th>
                    <th class="all">Assigned User</th>
                    <th class="all">Exam Start Date Time</th>
                    <th class="all">Exam Duration</th>
                    <th class="all">Exam End Date Time</th>
