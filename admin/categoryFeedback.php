...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo $ProjectName; ?> |Category Feedback </title>
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="categoryName" id="categoryName"  class="form-control" placeholder="Enter Feedback Category" required="" type="text">
...

            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo $web_url;?>admin/AjaxCategoryFeedback.php",
