                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">Search Store Locator</span>
                                        </div>
...
<!--                                                        <div class="form-group col-md-3">
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            <i class="icon-settings font-red-sunglo"></i>
                                            <span class="caption-subject bold uppercase">List of Store Locator</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
...
//                $('#ContactNumber').val('');
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxStoreLocator.php",
