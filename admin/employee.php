                            ...
                            <div class="col-md-12">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        ...
                                        <a href="<?php echo $web_url;?>admin/Addemployee.php" class="btn blue" style="float: right;" title="Add Company Employee">ADD Employee</a>
                                    </div>
                                    <div class="portlet-body form">
                                        <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                            ...
                                            <div class="form-actions  col-md-3">
                                                <button onclick="return  PageLoadData(1)" type="button" class="btn btn-primary" value="Search">Search</button>
                                            </div>
                                            <a href="<?php echo $web_url;?>admin/employeeExcel.php" class="btn blue" style="float: right;" title="Export To Excel">Export To Excel</a>
                                        </form>
