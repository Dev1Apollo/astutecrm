...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `quality`  " . $where . " and isDelete='0'  and  istatus='1' order by qualityId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `quality`  " . $where . " and isDelete='0' and  istatus='1' ";
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="desktop">No. of Call Audited</th>
                    <th class="desktop">Audit Score</th>
                    <th class="desktop">Auditor</th>
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['callAudited']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['auditScore']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['auditor']; ?>                           
                            </div>
                        </td>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['Remark']; ?>                           
                            </div>
                        </td>
                        <td>
