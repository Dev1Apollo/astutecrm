...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT *, (select empname from employee where employee.employeeid=onlinefeedback.complainby and isDelete=0)as complainByName FROM  onlinefeedback WHERE agentId ='".$_SESSION['EmployeeId']."' and (agentId = statusby or tLId = statusby or AMId = statusby or PMId = statusby)  and status = '2'  ORDER BY feedbackId desc";
     $countstr = "SELECT * from onlinefeedback where complainBy='".$_SESSION['EmployeeId']."' and istatus='1' and isDelete='0'";
     ...
     <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            ...
            <thead class="tbg">
                ...
                <tr style="background: #3f4296;">
                    ...
                    <th class="all"style="color: #fff;">Feedback Last Update Date</th>
