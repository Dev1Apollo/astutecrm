...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | CRM Followup Details </title>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>CRM Followup Details</span>
                            </li>
                        </ul>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of CRM Followup Details</span>
                            </div>
                            <?php if ($_SESSION['Designation'] == 6) { ?>
                                    ...
                                    <!--<a href="CRMExcel.php" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>-->
                            <?php } ?>
                        </div>
                            ...
                            <div class="row">
                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <a href="#" class="btn btn green pull-left" target="_blank" style="margin-right: 15px; margin-left: 10px;" onclick="exportToEmployeeData();"><i class="fa fa-file-excel-o"></i></a>
                                    </div>
                                </form>
                            </div>
                            <div class="row">
...
//                                                var lastDate = new Date(today.getFullYear(), today.getMonth(0) - 1, 31);
                                            ...
                                            function PageLoadData(Page) {
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo $web_url; ?>Employee/AjaxCMFollowupEmployee.php",
...
//                                            PageLoadData(1);
                                            function exportToEmployeeData() {
                                                var toDate = $('#toDate').val();
                                                var formDate = $('#formDate').val();
                                                window.location.href = 'CMFollowupEmployeeExcel.php?toDate=' + toDate + '&formDate=' + formDate;
                                            }
    </script>
</body>
