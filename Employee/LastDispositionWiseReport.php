...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Last Disposition Wise Report </title>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>Last Disposition Wise Report</span>
                            </li>
                        </ul>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Last Disposition Wise Data</span>
                            </div>

                            <a href="javascript:void(0);" onclick="ExportToExcel();" target="_blank" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
    ...
    <script type="text/javascript">
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Employee/AjaxLastDispositionWiseReport.php",
        ...
        function ExportToExcel() {
            ...
            var formDate = $('#formDate').val();
            var EmployeeId = $('#EmployeeId').val();
            var strURL = "LastDispositionWiseReportExcel.php?toDate=" + toDate + "&formDate=" + formDate + "&EmployeeId=" + EmployeeId;
            window.open(strURL);
        }
    </script>
</body>
