...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Paid Case </title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Paid Update</span>
                            </div>
...
<!--                                <a href="<?php echo $web_url; ?>Employee/AddPaidUpdate.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Paid Update"><i class="fa fa-upload"></i> </a>&nbsp;-->
                            <a href="AgentPaidCaseExcel.php" target="_blank" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
    ...
    <script type="text/javascript">
                                                        ...
                                                        function PageLoadData(Page) {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo $web_url; ?>Employee/AjaxAgentPaidCase.php",
                                                        ...
                                                        function ExportToExcel() {
                                                            ...
                                                            var applicatipnNo = $('#applicatipnNo').val();
                                                            var EmployeeId = $('#EmployeeId').val();
                                                            var strURL = "AgentPaidCaseExcel.php?toDate=" + toDate + "&formDate=" + formDate + "&applicatipnNo=" + applicatipnNo+"&EmployeeId="+EmployeeId;
                                                            window.open(strURL);
                                                        }
    </script>
</body>
