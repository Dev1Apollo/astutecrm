                              ...
                              <div class="portlet-body form">
                                 <form  role="form"  method="POST"  action="" name="frmquestion"  id="frmquestion" enctype="multipart/form-data">
                                    ...
                                    <div class="form-actions noborder">
                                       <input class="btn blue" type="submit" style="margin-top: 25px !important;" id="Btnmybtn"  value="Submit" name="submit">      
                                       <button type="button" class="btn blue" style="margin-top: 25px !important;" onClick="checkclose();">Cancel</button>
                                    </div>
                                 </form>
                              </div>
                           </div>
...

            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo $web_url;?>Employee/AjaxQuestionAnswer.php",
