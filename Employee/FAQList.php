                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">Search FAQ List</span>
                                        </div>
                                    </div>
                                ...
                                <div class="portlet light " style="display: none;" id="SLID">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            <i class="icon-settings font-red-sunglo"></i>
                                            <span class="caption-subject bold uppercase">List of FAQ List </span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
        ...
        <script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Employee/AjaxFAQList.php",
                    data: {action: 'ListUser', Page: Page, strfaq: strfaq},
                    success: function (msg) {
                        $('#SLID').show();
