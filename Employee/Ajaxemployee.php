        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="pop_in_heading">Manager T&Q</th> 
                    <th class="pop_in_heading">Manager Ops</th> 
                    <th class="pop_in_heading">Manager HR</th> 
                    <th class="pop_in_heading">Manager IT</th> 
                    <th class="pop_in_heading">Manager WFM/MIS</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-md-line-input ">
                                <?php
                                if($rowfilter['managerTQid'] > 0){
                                    $managerTQid = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `employee`  where isDelete='0'  and  istatus='1' and employeeid='" . $rowfilter['managerTQid'] . "' "));
                                    echo $managerTQid['empname']; 
                                } else {
                                    echo "-";
                                }
                                ?> 
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php
                                if($rowfilter['managerOpsid'] > 0){
                                $managerOpsid = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `employee`  where isDelete='0'  and  istatus='1' and employeeid='" . $rowfilter['managerOpsid'] . "' "));
                                echo $managerOpsid['empname']; 
                                } else {
                                echo "-";
                                }
                                ?> 
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php
                            if($rowfilter['managerHRid'] > 0){
                                $managerHRid = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `employee`  where isDelete='0'  and  istatus='1' and employeeid='" . $rowfilter['managerHRid'] . "' "));
                                echo $managerHRid['empname']; 
                            } else {
                                echo "-";
                                }
                                ?> 
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php
                            if($rowfilter['managerITid'] > 0){
                                $managerITid = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `employee`  where isDelete='0'  and  istatus='1' and employeeid='" . $rowfilter['managerITid'] . "' "));
                                echo $managerITid['empname'];
                                } else {
                                echo "-";
                                }?> 
                            </div>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php 
                            if($rowfilter['managerMISid'] > 0){
                                $managerMISid = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `employee`  where isDelete='0'  and  istatus='1' and employeeid='" . $rowfilter['managerMISid'] . "' "));
                                echo $managerMISid['empname'];
                            } else {
                                echo "-";
                                }
                                ?> 
