...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Upload CRM</title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">Upload CRM</span>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ()
        {
            $("#gallery").on('change', function ()
            {
                ...
                $("#ImageGallery").html('<img src="<?php echo $web_url; ?>Employee/global/img/input-spinner.gif" alt="Uploading...."/>');
