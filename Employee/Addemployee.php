                                    ...
                                    <div id="DivTeamLeader">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="iteamleadid" id="iteamleadid">
                                                ...
                                                $queryCom = "SELECT * FROM `employee` INNER JOIN employeedesignation on employee.employeeid=employeedesignation.iEmployeeId WHERE employee.centralmanagerId=".$_SESSION['EmployeeId']." and employeedesignation.iDesignationId=4 and employee.isDelete=0 and employee.istatus=1";
                                                $resultCom = mysqli_query($dbconn, $queryCom);
                                                while ($rowCom = mysqli_fetch_array($resultCom)) {
                                    ...
                                    <div id="DivQualityAnalist">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="qualityanalistid" id="qualityanalistid">
                                                ...
                                                $queryCom = "SELECT * FROM `employee` INNER JOIN employeedesignation on employee.employeeid=employeedesignation.iEmployeeId WHERE employee.centralmanagerId=".$_SESSION['EmployeeId']." and employeedesignation.iDesignationId=1 and employee.isDelete=0 and employee.istatus=1";
                                                $resultCom = mysqli_query($dbconn, $queryCom);
                                                while ($rowCom = mysqli_fetch_array($resultCom)) {
                                                    //  $empname = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `employee`  where isDelete='0'  and  istatus='1' and employeeid='" . $rowCom['iEmployeeId'] . "' "));
                                                    echo "<option value='" . $rowCom['employeeid'] . "'>" . $rowCom['empname'] . "</option>";
