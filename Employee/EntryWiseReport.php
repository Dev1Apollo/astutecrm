...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Entry Wise Report </title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Entry Wise Data</span>
                            </div>

<!--     href="EntryWiseReportExcel.php"                          target="_blank"   <a href="<?php echo $web_url; ?>Employee/AddPaidUpdate.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Paid Update"><i class="fa fa-upload"></i> </a>&nbsp;-->
                            <a href="javascript:void(0);" onclick="ExportToExcel();"  class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
    ...
    <script type="text/javascript">
                                                        ...
                                                        function PageLoadData(Page) {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo $web_url; ?>Employee/AjaxEntryWiseReport.php",
                                                                data: {action: 'ListUser', Page: Page, toDate: toDate, EmployeeId: EmployeeId, formDate: formDate, applicatipnNo: applicatipnNo},
                                                        ...
                                                        //     var applicatipnNo = $('#applicatipnNo').val();
                                                        //     var EmployeeId = $('#EmployeeId').val();
                                                        //     var strURL = "EntryWiseReportExcel.php?toDate=" + toDate + "&formDate=" + formDate +"&EmployeeId="+EmployeeId;
                                                        //     window.open(strURL);
                                                        // }
