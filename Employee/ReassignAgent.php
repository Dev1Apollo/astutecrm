                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            ...
                            <?php if ($_SESSION['Designation'] == 6) { ?>
                                <a href="<?php echo $web_url; ?>Employee/AddReassignAgent.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Reassign Agent"><i class="fa fa-upload"></i> </a> &nbsp;
                                <a href="ReassignExcel.php" target="_blank" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
                            <?php } ?>
                        </div>
