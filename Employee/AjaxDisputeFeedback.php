...
if ($_POST['action'] == 'ListUser') {
    ...
    // $filterstr = "SELECT *,(select empname from employee where employee.employeeid=historyfeedback.statusby and isDelete=0)as empname from historyfeedback where
    //  istatus='1' and isDelete='0'and status=2 ";
    $filterstr= "SELECT *, (select empname from employee where employee.employeeid=agentId and isDelete=0)as FeedbBackTo, (select empname from employee where employee.employeeid=statusby and isDelete=0)as StatusBy FROM  onlinefeedback WHERE complainBy = '".$_SESSION['EmployeeId']."' and status != '3' ORDER BY feedbackId"; 
     $countstr = "SELECT * from historyfeedback where statusby='".$_SESSION['EmployeeId']."' and istatus='1' and isDelete='0'";
