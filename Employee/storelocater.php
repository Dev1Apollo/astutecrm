...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Airtel Outlet</title>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">Search Airtel Outlet</span>
                            </div>
                            <?php 
                                if($_SESSION['Designation'] == 6){
                            ?>
                            <a href="uploadExcel.php" class="btn blue pull-right" title="Upload Excel"><i class="fa fa-upload"></i> </a>
                                <?php } ?>
                        </div>
                    ...
                    <div class="portlet light " style="display: none;" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase">List of Airtel Outlet</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
