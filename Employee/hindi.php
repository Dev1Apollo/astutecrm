...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">
        ...
        <div class="english_main">
            <div class="container">
                <div class="col-md-12 english_news">
                    <marquee onmouseover="this.stop()" onmouseout="this.start()" scrollamount="4">A scrolling text created with HTML Marquee element.</marquee>
                </div>
