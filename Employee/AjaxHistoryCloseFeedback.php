...
if ($_POST['action'] == 'ListUser') {
 ...
 echo $filterstr =" SELECT *,(select empname from employee where employee.employeeid=historyfeedback.statusby and isDelete=0)as complainByName  FROM historyfeedback WHERE feedbackId='".$_REQUEST['feedbackId']."' ORDER by historyFeedbackId ASC";
     ...
     <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            ...
            <thead class="tbg">
                ...
                <tr style="background: #3f4296;">
                    ...
                    <th class="all"style="color: #fff;">Feedback Comment Time</th>
                </tr>
