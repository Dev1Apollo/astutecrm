...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `application`  " . $where . " and isReassig=1 and isDelete='0'  and  iStatus='1' order by iAppId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `application`  " . $where . " and isReassig=1 and isDelete='0' and  istatus='1' ";
