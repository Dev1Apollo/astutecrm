...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title><?php echo $ProjectName; ?> |Received Feedback</title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="f_tab_main">
                                            <div class="f_tab_link">
                                                <a href="receivedFeedback.php" >Received Feedback</a>
                                                <a href="RespondFeedback.php" class="f_tab_link_active" >Respond Feedback</a>
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                           <h5 class="modal-title" id="Course">Response</h5>
...
<script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo $web_url;?>Employee/AjaxreceivedFeedback.php",
