...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Withdraw Case </title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Withdraw Case</span>
                            </div>
                            <?php if ($_SESSION['Designation'] == 6) { ?>
                                <a href="<?php echo $web_url; ?>Employee/AddWithdrawCase.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Withdraw Case"><i class="fa fa-upload"></i> </a>&nbsp;
                                <a href="WithdrawExcel.php" target="_blank" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
                            <?php } ?>
                        </div>
    ...
    <script type="text/javascript">
                                                        ...
                                                        function PageLoadData(Page) {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo $web_url; ?>Employee/AjaxWithdrawCase.php",
