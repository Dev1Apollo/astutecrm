...
$filterstr = "SELECT application.iAppId,application.bucket,application.isEmiPending,application.applicatipnNo,application.customerName,application.branch,application.state,application.customerAddress,application.customerCity, "
        ...
        . "applicationfollowup.strEntryDate,applicationfollowup.dispoType,applicationfollowup.followupDate,applicationfollowup.PTPDate,applicationfollowup.remark,applicationfollowup.mainDispoId,applicationfollowup.subDispoId,applicationfollowup.mainDispoId,applicationfollowup.followupDate,applicationfollowup.PTPDate,applicationfollowup.remark "
        . " FROM `application` LEFT JOIN (select * from applicationfollowup group by applicationfollowup.iAppId HAVING max(applicationfollowup.iAppLogId)) as "
