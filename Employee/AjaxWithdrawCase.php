...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `application`  " . $where . " and isWithdraw=1 and isDelete='0'  and  iStatus='1' order by iAppId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `application`  " . $where . " and isWithdraw=1 and isDelete='0' and  istatus='1' ";
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            <thead class="tbg">
                <tr>
                    ...
                    <th class="pop_in_heading">Withdraw Reason</th>
                </tr>
            </thead>
            <tbody>
                <?php
            ...
            <!--                        <td>
                        ...
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $rowfilter['bucket']; ?>                           
                            </div>
                        </td>
                        <td>
