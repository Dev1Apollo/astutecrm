...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | QualityScore</title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Quality Score</span>
                            </div>
                            <?php if ($_SESSION['Designation'] == 6) { ?>
                                <a href="<?php echo $web_url; ?>Employee/AddEmployeeQuality.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Employee Quality"><i class="fa fa-upload"></i> </a>
                            <?php } ?>
                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="Date" id="Date" class="form-control date-picker"> 
                                                    ...
                                                    <?php
                                                    $filterPerformance = mysqli_query($dbconn, "select * from quality GROUP by DATE_FORMAT(STR_TO_DATE(date,'%d-%M-%Y'), '%b-%y') ORDER BY STR_TO_DATE(date,'%d-%M-%Y') DESC limit 3");
...
//                                            echo "SELECT * FROM `employeedesignation` where iEmployeeId='" . $_SESSION['EmployeeId'] . "' and iDesignationId='4' and istatus='1' and isDelete='0'";
    ...
    <script type="text/javascript">
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Employee/AjaxQualityScore.php",
