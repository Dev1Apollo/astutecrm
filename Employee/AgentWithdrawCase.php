...
<html lang="en">
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            ...
                            <?php // if ($_SESSION['Designation'] == 6) { ?>
                                ...
                                <a href="AgentWithdrawExcel.php" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
                            <?php // } ?>
                        </div>
    ...
    <script type="text/javascript">
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo $web_url; ?>Employee/AjaxAgentWithdrawCase.php",
