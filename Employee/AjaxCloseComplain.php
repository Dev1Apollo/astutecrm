...
if ($_POST['action'] == 'ListUser') {
    $where = "where 1=1 ";
     ...
     $filterstr = "SELECT * from complainticket where complainBy='".$_SESSION['EmployeeId']."' and istatus='1' and isDelete='0' and ticketStatus !='0' order by ticketId desc";
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="tableC">
                <thead class="tbg">
                    <tr>
                        ...
                        <th class="pop_in_heading">Solution</th>
                        <th class="pop_in_heading">Solution Date & Time</th>
                    ...
                    <?php
                     ...
                     while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group form-md-line-input "><?php echo $rowfilter['floorAsset']; ?> 
                                </div>
                            </td> 
                            <td>
                            ...
                            <td>
                                <div class="form-group form-md-line-input "><?php echo $rowfilter['solution']; ?> 
                                </div>
                            </td> 
                            <td>
                                <div class="form-group form-md-line-input "><?php echo $rowfilter['closeDate']; ?> 
                                </div>
                            </td> 
