                                    ...
                                    <div class="portlet light ">
                                        <div class="f_tab_main">
                                            <div class="f_tab_link">
                                                <a href="TicketPending.php" >Pending Ticket</a>
                                                <a href="TicketClose.php" class="f_tab_link_active" >Closed Ticket</a>
                                            </div>
...
<script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo $web_url;?>Employee/AjaxTicketPending.php",
