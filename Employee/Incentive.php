...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Incentive </title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Incentive</span>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="Date" id="Date" class="form-control date-picker"> 
                                                    ...
                                                    <?php
                                                    $filterPerformance = mysqli_query($dbconn, "select * from incentivemaster GROUP by DATE_FORMAT(STR_TO_DATE(date,'%d-%M-%Y'), '%b-%y') ORDER BY STR_TO_DATE(date,'%d-%M-%Y') DESC limit 3");
                                            ...
                                            if($_SESSION['Designation'] == 6){ ?>
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select name="EmployeeId" id="EmployeeId" class="form-control"> 
                                                        <option value="">Select Employee</option>
                                                        <?php
                                                        $filterEmployee = mysqli_query($dbconn, "SELECT * FROM `employee` where istatus=1 and isDelete=0");
                                                        while ($rowEmployee = mysqli_fetch_array($filterEmployee)) {
                                                            ?>
                                                            <option value="<?php echo $rowEmployee['elisionloginid']; ?>"><?php echo $rowEmployee['empname']; ?></option>
                                                        <?php }
    ...
    <script type="text/javascript">
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Employee/AjaxIncentive.php",
