        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            ...
            <thead class="tbg">
                ...
                <tr style="background: #3f4296;">
                    ...
                    <th class="all" style="color: #fff;">SR</th>
                    <th class="all" style="color: #fff;">Question</th>
                    <th class="all" style="color: #fff;">Option1</th>
                    <th class="all" style="color: #fff;">Option2</th>
                    <th class="all" style="color: #fff;">Option3</th>
                    <th class="all" style="color: #fff;">Option4</th>
                    <th class="all" style="color: #fff;">Right Answer</th>
                    <th class="all" style="color: #fff;">Marks</th>
