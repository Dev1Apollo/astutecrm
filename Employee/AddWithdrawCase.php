...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Upload Withdraw Case</title>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span> Upload Withdraw Case</span>
                            </li>
                        </ul>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">Upload Withdraw Case</span>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form  role="form"  method="POST"  action="" name="frmuploadExcel"  id="frmuploadExcel" enctype="multipart/form-data" class="margin-bottom-40">
                                            <input type="hidden" value="AddWithdrawCase" name="action" id="action">
                                            <div class="form-body">
                                                <div class="row">
