...
<html lang="en">
                                ...
                                <div class="portlet light ">
                                        <div class="f_tab_main">
                                            <div class="f_tab_link">
                                                <a href="Exam.php" class="f_tab_link_active btn blue"  >Upcoming Exam</a>
                                                <a href="completeExam.php" class="btn ">Completed Exam</a>
                                            </div>
    ...
    function PageLoadData(Page) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $web_url; ?>Employee/AjaxCompleteExam.php",
