                ...
                <div class="page-content">
                    ...
                    <div class="portlet light " style="" id="SLID">
                        ...
                        <div class="portlet-body form">
                            <?php
                            $rowfilter = mysqli_fetch_array(mysqli_query($dbconn, "SELECT applicatipnNo,customerName,customerCity,customerZipcode,EMIAmount,customerMobile FROM `remove_application`  where iAppId='" . $_REQUEST['token'] . "'"));
                            ?>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
                                        ...
                                        <tbody>
                                            ...
                                            while ($rowfilterLF = mysqli_fetch_array($resultfilter)) {
                                                $customerentry = "SELECT customerName FROM `remove_application`  where isDelete='0'  and  istatus='1' and  iAppId='" . $rowfilterLF['iAppId'] . "'";
