...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Attendance</title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Attendance</span>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group col-md-3">
                                                <?php // echo "select * from employeeperformance GROUP by MONTH(date) limit 3";?>
...
//                                            echo "SELECT * FROM `employeedesignation` where iEmployeeId='" . $_SESSION['EmployeeId'] . "' and iDesignationId='4' and istatus='1' and isDelete='0'";
    ...
    <script type="text/javascript">
                                                    ...
                                                    function PageLoadData(Page) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "<?php echo $web_url; ?>Employee/AjaxAttendance.php",
