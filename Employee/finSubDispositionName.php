...
$result=mysqli_query($dbconn,"SELECT * FROM `dispositionmaster` where masterDispoId='".$ID."' and masterDispoId!=0");
if(mysqli_num_rows($result) > 0){
$data='<select name="sub_disposition" id="sub_disposition" required="" class="form-control" >
