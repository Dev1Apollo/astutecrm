...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Reassign Agent </title>
                    ...
                    <div class="portlet light " style="" id="SLID">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase">List of Reassign Agent</span>
                            </div>
                            <?php if ($_SESSION['Designation'] == 4 || $_SESSION['Designation'] == 2) { ?>
                                <a href="<?php echo $web_url; ?>Employee/AddTLandAMReassignAgent.php" class="btn blue pull-right margin-bottom-20" style="float: right;" title="ADD Reassign Agent"><i class="fa fa-upload"></i> </a> &nbsp;
                                <a href="ReassignTLandAMExcel.php" target="_blank" class="btn green pull-right margin-bottom-20" style="margin-right: 15px;" title="Employee"><i class="fa fa-file-excel-o"></i></a>
                            <?php } ?>
                        </div>
    ...
    <script type="text/javascript">
                                                        ...
                                                        function PageLoadData(Page) {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo $web_url; ?>Employee/AjaxReassignAgent.php",
