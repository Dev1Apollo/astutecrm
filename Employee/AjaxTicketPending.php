                 ...
                 while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-group form-md-line-input ">
                                <a onclick="Resloved('<?php echo $rowfilter['complainId']; ?>');"  title="Resloved" style="font-size:12px;"><strong> Reslove </strong></a>
