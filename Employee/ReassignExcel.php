...
$filterstr = "SELECT * FROM `application`  " . $where . "  and isReassig=1 and isDelete='0'  and  istatus='1' order by applicatipnNo asc";

$result1 = mysqli_query($dbconn, $filterstr);
if (mysqli_num_rows($result1) > 0) {
    $filename = 'CRM_Reassign_Data_' . date('d-m-Y H:s:i') . '.xls';
...
//. "\t Alt No"
    ...
    header('location:ReassignAgent.php');
}
exit;
